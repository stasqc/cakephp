...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="books index">
                    <h2><?php echo __('Search for a book: '); ?></h2>
                    <?php       echo $this->Form->create(array('controller' => 'Book', 'action' => 'search', 'type' => 'get'));
                                echo $this->Form->input('title', array('class' => 'form-control'));
                                echo $this->Form->submit('Search', array('class' => 'btn btn-large btn-primary'));
                                echo "<br/>";
                                echo $this->Form->end();
                    ?>
